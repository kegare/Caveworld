...
public class Config
{
	...
	public static void buildConfiguration()
	{
		...
		try
		{
			...
			biomeCaveworld = cfg.get("caveworld", "biomeCaveworld", biomeCaveworld, "Caveworld BiomeID (Default: 75)").getInt(biomeCaveworld);
			...
			portalCaveworld = cfg.getBlock("portalCaveworld", portalCaveworld, "Caveworld Portal BlockID (Default: 750)").getInt(portalCaveworld);
		}
		finally
		{
			if (cfg.hasChanged())
