...
public class TeleporterCavern extends Teleporter
{
	...
	public void placeInPortal(Entity entity, double posX, double posY, double posZ, float rotationYaw)
	{
		...
		if (entity instanceof EntityPlayerMP)
		{
			...
			if (CaveworldAPI.isEntityInCavern(player) && player.getBedLocation(player.dimension) == null)
			{
	...
	public boolean placeInExistingPortal(Entity entity, double posX, double posY, double posZ, float rotationYaw)
	{
		...
		else
		{
			for (int var2 = x - 128; var2 <= x + 128; ++var2)
			{
				...
				for (int var3 = z - 128; var3 <= z + 128; ++var3)
				{
					...
					{
						if (worldObj.getBlock(var2, y, var3) == CaveBlocks.cavern_portal)
						{
							while (worldObj.getBlock(var2, y - 1, var3) == CaveBlocks.cavern_portal)
							{
								--y;
							}
		...
		if (var1 >= 0.0D)
		{
			...
			if (worldObj.getBlock(blockX - 1, blockY, blockZ) == CaveBlocks.cavern_portal)
			{
				var5 = 2;
			}
			...
			if (worldObj.getBlock(blockX, blockY, blockZ - 1) == CaveBlocks.cavern_portal)
			{
				var5 = 3;
			}
	...
	public boolean makePortal(Entity entity)
	{
		...
		for (var6 = 0; var6 < 4; ++var6)
		{
			for (var7 = -1; var7 < 4; ++var7)
			{
				...
				{
					worldObj.setBlock(var10, var9, var12, CaveBlocks.cavern_portal, brickFrame ? 5 : 0, 2);
				}
			}
		}
