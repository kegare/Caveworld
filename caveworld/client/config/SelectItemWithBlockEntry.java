...
public class SelectItemWithBlockEntry extends ArrayEntry
{
	public SelectItemWithBlockEntry(GuiConfig owningScreen, GuiConfigEntries owningEntryList, IConfigElement configElement)
	{
