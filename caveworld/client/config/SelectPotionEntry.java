...
public class SelectPotionEntry extends ArrayEntry
{
	public SelectPotionEntry(GuiConfig owningScreen, GuiConfigEntries owningEntryList, IConfigElement configElement)
	{
	...
	public void valueButtonPressed(int index)
	{
		...
		else if (btnValue.enabled)
		{
			...
			mc.displayGuiScreen(new GuiSelectPotion(owningScreen, this));
		}
	}
}